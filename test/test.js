...
tape('convert directions v5 response to geojson', function(assert) {
...
tape('v4 offset', function(assert) {
    ...
    assert.ok(Math.abs(0.10-distances[0]) < 0.01, 'label 1 is offset 0.10km');
    assert.ok(Math.abs(0.05-distances[1]) < 0.01, 'label 2 is offset 0.05km');
    assert.ok(Math.abs(0.10-distances[2]) < 0.01, 'label 3 is offset 0.10km');
